      ...
      <div className="flex items-center justify-between mb-4 px-2">
        <div className="flex items-center gap-3">
          <a
            ...
            className="text-[color-mix(in_oklch,currentColor_80%,var(--color-primary))] hover:text-[var(--color-primary)] transition-colors relative group flex items-center gap-2"
            title={t("git.linkTitle")}
          >
            <span className="sr-only">{t("git.linkTitle")}</span>
            <svg
              className="w-5 h-5"
              fill="currentColor"
              viewBox="0 0 24 24"
