        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-10 max-w-7xl">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-center gap-2 md:gap-4 lg:gap-6 py-4">
            ...
            <div className="relative rounded-2xl overflow-hidden w-full md:w-auto md:max-w-md shrink-0">
              <img
                src="/assets/About/header-profile.png?v=2"
            ...
            <div className="flex flex-col justify-center space-y-4 md:space-y-6 md:py-4 min-w-0 md:max-w-xl">
              ...
              <div className="flex items-center flex-wrap gap-3 md:gap-4 pt-2">
                <a
                  ...
                  title={t("header.instagramSiegTitle")}
                >
                  <span className="sr-only">{t("header.instagramSiegTitle")}</span>
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                ...
                >
                  <span className="sr-only">{t("header.githubTitle")}</span>
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="text-[color-mix(in_oklch,currentColor_80%,var(--color-primary))] hover:text-[var(--color-primary)] transition-colors relative group"
                  title={t("header.linkedinTitle")}
                >
                  <span className="sr-only">{t("header.linkedinTitle")}</span>
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                ...
                <a
                  ...
                  rel="noopener noreferrer"
                  className="text-[color-mix(in_oklch,currentColor_80%,var(--color-primary))] hover:text-[var(--color-primary)] transition-colors relative group"
                  title={t("header.instagramThiagoTitle")}
                >
                  <span className="sr-only">{t("header.instagramThiagoTitle")}</span>
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                ...
                <button
                  ...
                  title={t("header.themeTitle", { theme })}
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-[color-mix(in_oklch,currentColor_80%,var(--color-primary))] hover:text-[var(--color-primary)] transition-colors group cursor-pointer relative"
                ...
                >
                  ...
                  <span className="text-xs font-semibold">{i18n.language?.startsWith("pt") ? "PT" : "EN"}</span>
                  <span className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-0 h-0.5 bg-[var(--color-primary)] group-hover:w-full transition-all duration-300"></span>
                </button>
              </div>
            </div>
