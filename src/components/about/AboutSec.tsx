      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <div className="p-6 rounded-xl border border-[color-mix(in_oklch,var(--color-primary)_10%,transparent)] bg-[color-mix(in_oklch,var(--color-primary)_5%,transparent)]">
            <h3 className="text-xl font-semibold mb-3">{t("about.cardAiTitle")}</h3>
          ...
          <div className="p-6 rounded-xl border border-[color-mix(in_oklch,var(--color-primary)_10%,transparent)] bg-[color-mix(in_oklch,var(--color-primary)_5%,transparent)]">
            <h3 className="text-xl font-semibold mb-3">{t("about.cardProductTitle")}</h3>
            <p className="text-sm/relaxed">
              {t("about.cardProductBody")}
            </p>
          </div>

          <div className="p-6 rounded-xl border border-[color-mix(in_oklch,var(--color-primary)_10%,transparent)] bg-[color-mix(in_oklch,var(--color-primary)_5%,transparent)]">
            <h3 className="text-xl font-semibold mb-3">{t("about.cardCommTitle")}</h3>
            <p className="text-sm/relaxed">
              {t("about.cardCommBody")}
            </p>
          </div>
        </div>
