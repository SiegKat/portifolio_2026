...
export default function CompactAbout({
  ...
  const defaultProfileData = {
    ...
    links: [
      { label: t("compact.linkInstagram"), url: "https://www.instagram.com/sieg.ia/" },
      { label: t("compact.linkGithub"), url: "https://github.com/SiegKat" },
      { label: t("compact.linkLinkedin"), url: "https://www.linkedin.com/in/thiagosieg/" },
    ],
  };
        ...
        {loading ? (
          ...
          <>
            ...
            {projects.length > 3 && (
              ...
              >
                {showAllProjects ? t("compact.showLess") : t("compact.viewAllProjects")}
              </button>
            )}
          </>
        )}
