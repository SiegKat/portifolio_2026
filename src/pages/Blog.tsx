    ...
    >
      ...
      {filteredPosts.length === 0 ? (
        <div className="text-center py-10">
          <p>
            {t("blog.emptyBase")}{selectedTag ? t("blog.emptyWithTag", { tag: selectedTag }) : ""}
            {selectedType ? t("blog.emptyWithType", { type: selectedType }) : ""}
          </p>
